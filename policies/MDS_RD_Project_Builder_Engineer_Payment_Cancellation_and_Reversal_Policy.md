# MDS RD Project Builder — Engineer Payment, Cancellation & Reversal Policy

**Effective date:** 20 September 2026  
**Operator:** Magen Daniel Systems LLP (“MDS”)  
**Application:** MDS RD Project Builder

This policy governs engineer compensation, milestone cancellation, payment adjustment, and reversal situations for work performed through MDS RD Project Builder.

## 1. Milestone-based compensation
Engineer compensation is tied to the agreed project or milestone scope. A milestone may require MDS technical review before approval and release.

## 2. Normal clarification does not change price
Questions, technical clarification, coordination with MDS engineers, reasonable progress updates, and information required to complete the agreed scope do not automatically justify a price increase.
